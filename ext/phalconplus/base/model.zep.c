...
PHP_METHOD(PhalconPlus_Base_Model, getFirstMessage) {
	...
	if (zephir_fast_count_int(&_0 TSRMLS_CC)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_4$$3, "current", NULL, 34, &_2$$3);
		zephir_check_call_status();
...
PHP_METHOD(PhalconPlus_Base_Model, getLastMessage) {
	...
	if (zephir_fast_count_int(&_0 TSRMLS_CC)) {
		...
		ZEPHIR_CALL_FUNCTION(&_4$$3, "end", NULL, 35, &_2$$3);
		ZEPHIR_UNREF(&_2$$3);
		zephir_check_call_status();
		zephir_get_strval(&_5$$3, &_4$$3);
		RETURN_CTOR(&_5$$3);
...
PHP_METHOD(PhalconPlus_Base_Model, batchInsert) {
	...
	if ((zephir_method_exists_ex(&model, SL("columnmap") TSRMLS_CC) == SUCCESS)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&columnMap, "array_flip", NULL, 36, &_2$$3);
		zephir_check_call_status();
...
PHP_METHOD(PhalconPlus_Base_Model, findByPagable) {
	...
	ZEPHIR_CALL_FUNCTION(&orderBys, "array_map", NULL, 27, &_3, &_2);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&_7) == IS_OBJECT) {
		...
		if (zephir_array_isset_string_fetch(&hydration$$10, &params, SL("hydration"), 0)) {
			ZEPHIR_CALL_METHOD(&_8$$11, &page, "getitems", NULL, 0);
			zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_9, &page, "gettotalitems", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_10, &page, "getitems", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 38, pagable, &_9, &_10);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(PhalconPlus_Base_Model, setUpdateCond) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "setupdatecondition", NULL, 0, &params);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(PhalconPlus_Base_Model, setUpdateCondition) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *params_param = NULL, __$null, metaData, writeConnection, columnMap, bindDataTypes, primaryKeys, attributeField, pk, value, type, whereUk, uniqueParams, uniqueTypes, *_0, _1, conditions, bind, bindTypes, _17, _26, _27, _28, _29, countKeys, _30, _31, _32, _34, _35, _36, _37, _40, _41, _42, _43, _2$$5, _3$$5, _5$$7, _6$$7, _7$$3, _9$$3, _10$$12, _11$$12, _12$$14, _13$$14, _14$$10, _16$$10, _18$$18, _19$$18, _20$$19, _21$$19, _22$$19, _23$$20, _24$$20, _25$$20, _33$$22, _39$$24;
	zval params;
	zval *this_ptr = getThis();
	...
	zephir_check_call_status();
	zephir_is_iterable(&primaryKeys, 0, "phalconplus/Base/Model.zep", 291);
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&primaryKeys), _0)
		{
			...
			if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
				...
				if (!(zephir_array_isset_fetch(&attributeField, &columnMap, &pk, 0 TSRMLS_CC))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_2$$5, "__construct", &_4, 22, &_3$$5);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_2$$5, "phalconplus/Base/Model.zep", 268 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
			} else {
			...
			if (!(zephir_array_isset_fetch(&type, &bindDataTypes, &pk, 0 TSRMLS_CC))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_5$$7, "__construct", &_4, 22, &_6$$7);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_5$$7, "phalconplus/Base/Model.zep", 275 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
			ZEPHIR_OBS_NVAR(&value);
			if (zephir_fetch_property_zval(&value, this_ptr, &attributeField, PH_SILENT_CC)) {
				zephir_array_append(&uniqueParams, &value, PH_SEPARATE, "phalconplus/Base/Model.zep", 279);
			} else {
				zephir_array_append(&uniqueParams, &__$null, PH_SEPARATE, "phalconplus/Base/Model.zep", 281);
			}
			ZEPHIR_CALL_METHOD(&_7$$3, &writeConnection, "escapeidentifier", &_8, 0, &pk);
			zephir_check_call_status();
			ZEPHIR_INIT_LNVAR(_9$$3);
			ZEPHIR_CONCAT_VS(&_9$$3, &_7$$3, " = ?");
			zephir_array_append(&whereUk, &_9$$3, PH_SEPARATE, "phalconplus/Base/Model.zep", 284);
			zephir_array_append(&uniqueTypes, &type, PH_SEPARATE, "phalconplus/Base/Model.zep", 285);
		} ZEND_HASH_FOREACH_END();
	} else {
			...
			zephir_check_call_status();
				if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
					...
					if (!(zephir_array_isset_fetch(&attributeField, &columnMap, &pk, 0 TSRMLS_CC))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_10$$12, "__construct", &_4, 22, &_11$$12);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_10$$12, "phalconplus/Base/Model.zep", 268 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
				} else {
				...
				if (!(zephir_array_isset_fetch(&type, &bindDataTypes, &pk, 0 TSRMLS_CC))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_12$$14, "__construct", &_4, 22, &_13$$14);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_12$$14, "phalconplus/Base/Model.zep", 275 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				ZEPHIR_OBS_NVAR(&value);
				...
				zephir_array_append(&whereUk, &_16$$10, PH_SEPARATE, "phalconplus/Base/Model.zep", 284);
				zephir_array_append(&uniqueTypes, &type, PH_SEPARATE, "phalconplus/Base/Model.zep", 285);
	...
	zephir_read_property(&_17, this_ptr, SL("uniqueKey"), PH_NOISY_CC | PH_READONLY);
	if (!(ZEPHIR_IS_EMPTY(&_17))) {
		zephir_read_property(&_18$$18, this_ptr, SL("uniqueKey"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_VAR(&_19$$18);
		ZEPHIR_CONCAT_VS(&_19$$18, &_18$$18, " AND ");
		zephir_update_property_zval(this_ptr, SL("uniqueKey"), &_19$$18);
	}
	if (Z_TYPE_P(&conditions) == IS_ARRAY) {
		zephir_merge_append(&whereUk, &conditions);
		zephir_read_property(&_20$$19, this_ptr, SL("uniqueKey"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_VAR(&_21$$19);
		zephir_fast_join_str(&_21$$19, SL(" AND "), &whereUk TSRMLS_CC);
		ZEPHIR_INIT_VAR(&_22$$19);
		ZEPHIR_CONCAT_VV(&_22$$19, &_20$$19, &_21$$19);
		zephir_update_property_zval(this_ptr, SL("uniqueKey"), &_22$$19);
	} else if (Z_TYPE_P(&conditions) == IS_STRING) {
		ZEPHIR_INIT_VAR(&_23$$20);
		zephir_fast_join_str(&_23$$20, SL(" AND "), &whereUk TSRMLS_CC);
		ZEPHIR_INIT_VAR(&_24$$20);
		ZEPHIR_CONCAT_VSV(&_24$$20, &_23$$20, " AND ", &conditions);
		ZEPHIR_CPY_WRT(&conditions, &_24$$20);
		zephir_read_property(&_25$$20, this_ptr, SL("uniqueKey"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_LNVAR(_24$$20);
		ZEPHIR_CONCAT_VV(&_24$$20, &_25$$20, &conditions);
		zephir_update_property_zval(this_ptr, SL("uniqueKey"), &_24$$20);
	}
	ZEPHIR_INIT_VAR(&_26);
	ZEPHIR_CALL_FUNCTION(&_27, "array_values", NULL, 21, &columnMap);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_28);
	zephir_array_keys(&_28, &columnMap TSRMLS_CC);
	zephir_read_property(&_29, this_ptr, SL("uniqueKey"), PH_NOISY_CC | PH_READONLY);
	zephir_fast_str_replace(&_26, &_27, &_28, &_29 TSRMLS_CC);
	zephir_update_property_zval(this_ptr, SL("uniqueKey"), &_26);
	zephir_read_property(&_30, this_ptr, SL("uniqueKey"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_31);
	ZVAL_STRING(&_31, "= ?");
	ZEPHIR_CALL_FUNCTION(&countKeys, "substr_count", NULL, 32, &_30, &_31);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&bind);
	if (zephir_array_isset_string_fetch(&bind, &params, SL("bind"), 0)) {
		zephir_merge_append(&uniqueParams, &bind);
	}
	zephir_read_property(&_32, this_ptr, SL("uniqueParams"), PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_32) == IS_NULL) {
		ZEPHIR_INIT_VAR(&_33$$22);
		array_init(&_33$$22);
		zephir_update_property_zval(this_ptr, SL("uniqueParams"), &_33$$22);
	}
	zephir_read_property(&_34, this_ptr, SL("uniqueParams"), PH_NOISY_CC | PH_READONLY);
	zephir_merge_append(&_34, &uniqueParams);
	zephir_read_property(&_35, this_ptr, SL("uniqueParams"), PH_NOISY_CC | PH_READONLY);
	ZVAL_NULL(&_36);
	ZEPHIR_CALL_FUNCTION(&_37, "array_pad", &_38, 39, &_35, &countKeys, &_36);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("uniqueParams"), &_37);
	...
	zephir_read_property(&_36, this_ptr, SL("uniqueTypes"), PH_NOISY_CC | PH_READONLY);
	if (Z_TYPE_P(&_36) == IS_NULL) {
		ZEPHIR_INIT_VAR(&_39$$24);
		array_init(&_39$$24);
		zephir_update_property_zval(this_ptr, SL("uniqueTypes"), &_39$$24);
	}
	zephir_read_property(&_40, this_ptr, SL("uniqueTypes"), PH_NOISY_CC | PH_READONLY);
	zephir_merge_append(&_40, &uniqueTypes);
	zephir_read_property(&_41, this_ptr, SL("uniqueTypes"), PH_NOISY_CC | PH_READONLY);
	ZVAL_LONG(&_42, 1024);
	ZEPHIR_CALL_FUNCTION(&_43, "array_pad", &_38, 39, &_41, &countKeys, &_42);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("uniqueTypes"), &_43);
	RETURN_MM_BOOL(1);
...
PHP_METHOD(PhalconPlus_Base_Model, setUqKeys) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "setuniquekeys", NULL, 0, &whereUk);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(PhalconPlus_Base_Model, setUniqueKeys) {
	...
	ZEPHIR_CALL_METHOD(&bindDataTypes, &metaData, "getbindtypes", NULL, 0, this_ptr);
	zephir_check_call_status();
	zephir_is_iterable(&whereUk, 0, "phalconplus/Base/Model.zep", 381);
	if (Z_TYPE_P(&whereUk) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&whereUk), _0)
		{
			...
			if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
				ZEPHIR_CALL_FUNCTION(&tmp$$4, "array_flip", &_2, 36, &columnMap);
				zephir_check_call_status();
				...
				if (!(zephir_array_isset_fetch(&field, &tmp$$4, &attributeField, 0 TSRMLS_CC))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_3$$5, "__construct", &_5, 22, &_4$$5);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_3$$5, "phalconplus/Base/Model.zep", 367 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
			} else {
			...
			if (!(zephir_array_isset_fetch(&type, &bindDataTypes, &field, 0 TSRMLS_CC))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_6$$7, "__construct", &_5, 22, &_7$$7);
				zephir_check_call_status();
				zephir_throw_exception_debug(&_6$$7, "phalconplus/Base/Model.zep", 376 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		...
		while (1) {
			...
			zephir_check_call_status();
				if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
					ZEPHIR_CALL_FUNCTION(&tmp$$9, "array_flip", &_2, 36, &columnMap);
					zephir_check_call_status();
					ZEPHIR_OBS_NVAR(&field);
					if (!(zephir_array_isset_fetch(&field, &tmp$$9, &attributeField, 0 TSRMLS_CC))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_9$$10, "__construct", &_5, 22, &_10$$10);
						zephir_check_call_status();
						zephir_throw_exception_debug(&_9$$10, "phalconplus/Base/Model.zep", 367 TSRMLS_CC);
						ZEPHIR_MM_RESTORE();
						return;
					}
				} else {
				...
				if (!(zephir_array_isset_fetch(&type, &bindDataTypes, &field, 0 TSRMLS_CC))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_11$$12, "__construct", &_5, 22, &_12$$12);
					zephir_check_call_status();
					zephir_throw_exception_debug(&_11$$12, "phalconplus/Base/Model.zep", 376 TSRMLS_CC);
					ZEPHIR_MM_RESTORE();
					return;
				}
				zephir_update_property_array_multi(this_ptr, SL("__p_UK"), &type TSRMLS_CC, SL("zs"), 3, &attributeField, SL("type"));
...
PHP_METHOD(PhalconPlus_Base_Model, _p_buildUkCond) {
	...
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zval *metaData, metaData_sub, *connection, connection_sub, __$null, value, type, info, field, whereUk, uniqueParams, uniqueTypes, attributeField, _0, *_1, _2, usefulParams, _13, _14, selfVal$$4, _5$$3, _7$$3, _8$$3, selfVal$$9, _9$$8, _11$$8, _12$$8;
	zval *this_ptr = getThis();
	...
	array_init(&uniqueTypes);
	zephir_read_property(&_0, this_ptr, SL("__p_UK"), PH_NOISY_CC | PH_READONLY);
	zephir_is_iterable(&_0, 0, "phalconplus/Base/Model.zep", 410);
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_0), _3, _4, _1)
		{
			...
			ZVAL_COPY(&info, _1);
			ZEPHIR_OBS_NVAR(&type);
			zephir_array_fetch_string(&type, &info, SL("type"), PH_NOISY, "phalconplus/Base/Model.zep", 393 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&field);
			zephir_array_fetch_string(&field, &info, SL("field"), PH_NOISY, "phalconplus/Base/Model.zep", 394 TSRMLS_CC);
			...
			if (zephir_fetch_property_zval(&value, this_ptr, &attributeField, PH_SILENT_CC)) {
				...
				if (zephir_array_isset_string_fetch(&selfVal$$4, &info, SL("value"), 0)) {
					zephir_array_append(&uniqueParams, &selfVal$$4, PH_SEPARATE, "phalconplus/Base/Model.zep", 399);
				} else {
					zephir_array_append(&uniqueParams, &value, PH_SEPARATE, "phalconplus/Base/Model.zep", 401);
				}
			} else {
				zephir_array_append(&uniqueParams, &__$null, PH_SEPARATE, "phalconplus/Base/Model.zep", 404);
			}
			zephir_array_append(&uniqueTypes, &type, PH_SEPARATE, "phalconplus/Base/Model.zep", 406);
			ZEPHIR_CALL_METHOD(&_5$$3, connection, "escapeidentifier", &_6, 0, &field);
			zephir_check_call_status();
			zephir_array_fetch_string(&_7$$3, &info, SL("op"), PH_NOISY | PH_READONLY, "phalconplus/Base/Model.zep", 407 TSRMLS_CC);
			ZEPHIR_INIT_LNVAR(_8$$3);
			ZEPHIR_CONCAT_VSVS(&_8$$3, &_5$$3, " ", &_7$$3, " ?");
			zephir_array_append(&whereUk, &_8$$3, PH_SEPARATE, "phalconplus/Base/Model.zep", 407);
		} ZEND_HASH_FOREACH_END();
	} else {
			...
			zephir_check_call_status();
				...
				if (zephir_fetch_property_zval(&value, this_ptr, &attributeField, PH_SILENT_CC)) {
					...
					if (zephir_array_isset_string_fetch(&selfVal$$9, &info, SL("value"), 0)) {
						zephir_array_append(&uniqueParams, &selfVal$$9, PH_SEPARATE, "phalconplus/Base/Model.zep", 399);
					} else {
						zephir_array_append(&uniqueParams, &value, PH_SEPARATE, "phalconplus/Base/Model.zep", 401);
					}
				} else {
				...
				zephir_array_append(&uniqueTypes, &type, PH_SEPARATE, "phalconplus/Base/Model.zep", 406);
				ZEPHIR_CALL_METHOD(&_9$$8, connection, "escapeidentifier", &_10, 0, &field);
				zephir_check_call_status();
				zephir_array_fetch_string(&_11$$8, &info, SL("op"), PH_NOISY | PH_READONLY, "phalconplus/Base/Model.zep", 407 TSRMLS_CC);
				ZEPHIR_INIT_LNVAR(_12$$8);
				ZEPHIR_CONCAT_VSVS(&_12$$8, &_9$$8, " ", &_11$$8, " ?");
				zephir_array_append(&whereUk, &_12$$8, PH_SEPARATE, "phalconplus/Base/Model.zep", 407);
	...
	zephir_create_closure_ex(&_13, NULL, phalconplus_1__closure_ce, SL("__invoke"));
	ZEPHIR_CALL_FUNCTION(&usefulParams, "array_filter", NULL, 19, &uniqueParams, &_13);
	zephir_check_call_status();
	if (ZEPHIR_IS_EMPTY(&usefulParams)) {
		RETURN_MM_BOOL(0);
	}
	ZEPHIR_INIT_VAR(&_14);
	zephir_fast_join_str(&_14, SL(" AND "), &whereUk TSRMLS_CC);
	zephir_update_property_zval(this_ptr, SL("uniqueKey"), &_14);
...
PHP_METHOD(PhalconPlus_Base_Model, getUniqueFields) {
	...
	ZEPHIR_OBS_VAR(&_0);
	zephir_read_property(&_0, this_ptr, SL("uniqueKey"), PH_NOISY_CC);
	zephir_array_update_string(return_value, SL("key"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property(&_0, this_ptr, SL("uniqueParams"), PH_NOISY_CC);
	zephir_array_update_string(return_value, SL("params"), &_0, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(&_0);
	zephir_read_property(&_0, this_ptr, SL("uniqueTypes"), PH_NOISY_CC);
...
PHP_METHOD(PhalconPlus_Base_Model, toProtoBuffer) {
	...
	zephir_is_iterable(&toArray, 0, "phalconplus/Base/Model.zep", 442);
	if (Z_TYPE_P(&toArray) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&toArray), _2, _3, _0)
		{
			...
			if (zephir_is_scalar(&val)) {
				...
				ZEPHIR_CALL_FUNCTION(&_4$$3, "strval", &_5, 31, &val);
				zephir_check_call_status();
			}
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (zephir_is_scalar(&val)) {
					...
					ZEPHIR_CALL_FUNCTION(&_6$$4, "strval", &_5, 31, &val);
					zephir_check_call_status();
				}
	...
	zephir_check_call_status();
	zephir_is_iterable(&relations, 0, "phalconplus/Base/Model.zep", 463);
	if (Z_TYPE_P(&relations) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&relations), _7)
		{
			...
			if (zephir_array_isset_string_fetch(&alias, &options, SL("alias"), 0)) {
				if (Z_TYPE_P(&alias) != IS_STRING) {
					ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zend_exception_get_default(TSRMLS_C), "Relation alias must be a string", "phalconplus/Base/Model.zep", 452);
					return;
				}
			...
			ZEPHIR_CALL_FUNCTION(&property$$5, "lcfirst", &_9, 40, &alias);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&property$$9, "lcfirst", &_9, 40, &alias);
				zephir_check_call_status();
