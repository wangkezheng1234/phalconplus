...
PHP_METHOD(PhalconPlus_Http_PsrRequest, __construct) {
	...
	zephir_is_iterable(&_53, 0, "phalconplus/Http/PsrRequest.zep", 82);
...
PHP_METHOD(PhalconPlus_Http_PsrRequest, mapFiles) {
	...
	zephir_is_iterable(&uploads, 0, "phalconplus/Http/PsrRequest.zep", 120);
...
PHP_METHOD(PhalconPlus_Http_PsrRequest, removeTmpFiles) {
	...
	zephir_is_iterable(&_0, 0, "phalconplus/Http/PsrRequest.zep", 132);
...
PHP_METHOD(PhalconPlus_Http_PsrRequest, isAjax) {
	...
	if (_1) {
		...
		zephir_array_fetch_string(&_3, &_2, SL("HTTP_X_REQUESTED_WITH"), PH_NOISY | PH_READONLY, "phalconplus/Http/PsrRequest.zep", 144 TSRMLS_CC);
...
PHP_METHOD(PhalconPlus_Http_PsrRequest, isSoap) {
	...
	if (zephir_array_isset_string(&_0, SL("HTTP_SOAPACTION"))) {
		...
		if (!(ZEPHIR_IS_EMPTY(&contentType))) {
			RETURN_MM_BOOL(zephir_memnstr_str(&contentType, SL("application/soap+xml"), "phalconplus/Http/PsrRequest.zep", 158));
		}
	}
	RETURN_MM_BOOL(0);
